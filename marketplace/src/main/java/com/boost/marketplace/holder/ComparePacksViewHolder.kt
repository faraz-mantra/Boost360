...
class ComparePacksViewHolder(binding: ActivityPacksBinding) :
    AppBaseRecyclerViewHolder<ActivityPacksBinding>(binding) {
...
////            binding.packageTitle.text = parentItem.desc
////        }else{
...
//
//        val layoutManager1 = LinearLayoutManager(binding.childRecyclerview.context,
...
//            binding.packageAddCartNew.setText("Added To Cart")
//         //   this.onPackageClicked(parentItem,parentViewHolder.package_profile_image_compare_new)
//        }
//
//    }
//
