...
class MarketPlaceOffersActivity : AppBaseActivity<ActivityMarketplaceoffersBinding, MarketPlaceOffersViewModel>() {
    ...
    override fun onCreateView()  {
     ...
     //   initMvvm()
       ...
       binding?.offerTitle?.setText(marketOffersData!!.title)
...
//            marketOfferDetailAdapter = MarketOfferDetailAdapter(list, this)
        ...
        val clickableSpan: ClickableSpan = object : ClickableSpan() {
            override fun onClick(textView: View) {
                Toast.makeText(this@MarketPlaceOffersActivity, "On Clicked ", Toast.LENGTH_SHORT).show()
            }
...
//        }
        ...
        if (marketOffersData!!.image != null && !marketOffersData!!.image!!.url.isNullOrEmpty()) {
            Glide.with(this).load(marketOffersData!!.image!!.url).into(binding?.marketoffersImage!!)
        } else {
        ...
        binding!!.dateFromToLayout.setOnClickListener {
            ...
            Toast.makeText(this, "Coupon " + avail_coupon_txt.text + " copied!!", Toast.LENGTH_SHORT)
                .show()
        ...
        binding!!.availCouponSubmit.setOnClickListener {
            ...
            val clip = ClipData.newPlainText(avail_coupon_txt.text, avail_coupon_txt.text)
            clipboard.setPrimaryClip(clip)
//            (activity as UpgradeActivity).popActivityFromBackStack()
            Toast.makeText(this, "Coupon " + avail_coupon_txt.text + " copied!!", Toast.LENGTH_SHORT)
                .show()
        }
