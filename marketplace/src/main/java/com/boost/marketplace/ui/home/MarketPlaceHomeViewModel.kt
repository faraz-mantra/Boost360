...
class MarketPlaceHomeViewModel(val application: Application): BaseViewModel() {
  ...
  fun getAllFeaturesForMarketplace(auth:String,fpid: String, clientId: String, expCode: String?, fpTag: String? ,website_id: String? = "5e7a3cf46e0572000109a5b2",activity: MarketPlaceActivity) {
