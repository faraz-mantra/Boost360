...
class MarketPlaceOfferFragment : BaseFragment(), HistoryFragmentListener {
  ...
  override fun onCreateView(
    ...
    marketOffersData = Gson().fromJson<MarketPlaceOffers>(
      jsonString,
      object : TypeToken<MarketPlaceOffers>() {}.type
    )
...
//            )
    ...
    date_from_to_layout.setOnClickListener {
      ...
      Toast.makeText(activity, "Coupon " + avail_coupon_txt.text + " copied!!", Toast.LENGTH_SHORT)
        .show()
    }
