...
//            viewModel.getCartItems()
      Log.v(
        "COMPARE_BACK_VALUE", " " + Constants.COMPARE_BACK_VALUE + " cartCount: " + cartCount +
...
//        layoutManager.isMeasurementCacheEnabled = false
    val parentItemAdapter =
      ParentCompareItemAdapter(upgradeList, (activity as UpgradeActivity), this)
...
//                                            featuresList = it
                ...
                viewModel.addItemToCartPackage(
                  CartModel(
                    item!!._kid,
                    null,
                    null,
