...
//    var couponCodeForApplyCoupon: String = ""
    ...
    private lateinit var shimmerViewBanner:ShimmerFrameLayout
...
//    localStorage = LocalStorage.getInstance(requireContext())!!
        ...
        shimmerViewBanner = root.findViewById<ShimmerFrameLayout>(R.id.shimmer_view_banner)
        ...
        if (ac.isBackCart.not() && (ac.isDeepLink || ac.isOpenCardFragment)) {
            ...
            viewModel.renewalResult().observeOnce(Observer { result ->
                ...
                if (renewalList.isNotEmpty()) {
                    ...
                    cartList = list
                    if (shimmerViewBanner.isShimmerStarted) {
    ...
    fun initMvvM() {
        ...
        viewModel.cartResult().observe(this, Observer {
            if (it.isNullOrEmpty().not()) {
                ...
                shimmerViewBanner.visibility = GONE
