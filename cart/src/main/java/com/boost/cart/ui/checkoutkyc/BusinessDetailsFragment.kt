...
import com.boost.cart.interfaces.BusinessDetailListener
import com.boost.cart.ui.payment.PaymentViewModel
import com.boost.cart.ui.popup.StateListPopFragment
import com.boost.cart.utils.Constants.Companion.STATE_LIST_FRAGMENT
...
class BusinessDetailsFragment : DialogFragment() {
  ...
  private var gstInfoResult: com.boost.cart.data.api_model.gst.Result? = null
