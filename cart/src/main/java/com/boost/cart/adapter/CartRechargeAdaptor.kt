...
class CartRechargeAdaptor(cardItems: List<CartModel>?, val listener: CartFragmentListener, val activity: Activity) :
  RecyclerView.Adapter<CartRechargeAdaptor.upgradeViewHolder>() {
