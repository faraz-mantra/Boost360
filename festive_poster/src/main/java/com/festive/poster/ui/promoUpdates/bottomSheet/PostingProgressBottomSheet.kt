...
import com.framework.webengageconstant.Promotional_Updates_Post_On_Platforms_Click

class PostingProgressBottomSheet : BaseBottomSheetDialog<BsheetPostingProgressBinding, BaseViewModel>() {
  ...
  override fun onCreateView() {
    WebEngageController.trackEvent(Promotional_Updates_Post_On_Platforms_Click)
