...
import com.festive.poster.databinding.SocialPreviewGmbNoImageBinding
...
class GMBPreviewNoImageViewHolder(binding: SocialPreviewGmbNoImageBinding) :
    AppBaseRecyclerViewHolder<SocialPreviewGmbNoImageBinding>(binding) {
