...
class RiaAcademyViewHolder(binding: ItemRiaAcademyBinding) : AppBaseRecyclerViewHolder<ItemRiaAcademyBinding>(binding) {
  ...
  override fun bind(position: Int, item: BaseRecyclerViewItem) {
    ...
    binding.maimView.setOnClickListener { listener?.onItemClick(position,data, RecyclerViewActionType.PROMO_BOOST_ACADEMY_CLICK.ordinal) }
  }
}
