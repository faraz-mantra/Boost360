...
object WebEngageController {
    ...
    fun setUserContactAttributes(email: String?, mobile: String?, name: String?, company: String?, fpTag: String?) =
            NFWebEngageController.setUserContactAttributes(email, mobile, name, company, fpTag)
