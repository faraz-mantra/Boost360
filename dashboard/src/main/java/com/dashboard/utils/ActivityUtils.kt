...
fun AppCompatActivity.startAptOrderSummary(session: UserSessionManager?) {
    try {
        ...
        val queries =
            Intent(this, Class.forName("com.nowfloats.Analytics_Screen.OrderSummaryActivity"))
        startActivity(queries)
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    } catch (e: Exception) {
        e.printStackTrace()
...
//    val intent = Intent(this, Class.forName("com.boost.marketplace.ui.details.FeatureDetailsActivity"))
...
//        intent.putExtra("email", "suhas4090@gmail.com")
//        intent.putExtra("currency", "INR")
//        intent.putExtra("contact", "9738084090")
//        startActivity(intent)
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    } catch (e: Exception) {
        e.printStackTrace()
...
fun AppCompatActivity.startAppActivity(bundle: Bundle = Bundle(), fragmentType: String) {
    try {
        val intent =
            Intent(this, Class.forName("com.nowfloats.helper.AppFragmentContainerActivity"))
...
fun AppCompatActivity.startMobileSite(
    session: UserSessionManager?,
    website: String,
    eventname: String = MOBILE_SITE_PAGE
) {
    try {
...
fun AppCompatActivity.startAddImageGallery(session: UserSessionManager?, isCreate: Boolean = true) {
    try {
        ...
        val webIntent =
            Intent(this, Class.forName("com.nowfloats.Image_Gallery.ImageGalleryActivity"))
...
fun AppCompatActivity.startBusinessLogo(session: UserSessionManager?) {
    try {
        ...
        val webIntent = Intent(
            this,
            Class.forName("com.nowfloats.BusinessProfile.UI.UI.Business_Logo_Activity")
        )
        startActivity(webIntent)
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    } catch (e: ClassNotFoundException) {
...
fun AppCompatActivity.startBusinessAddress(session: UserSessionManager?) {
    try {
        ...
        val webIntent = Intent(
            this,
            Class.forName("com.nowfloats.BusinessProfile.UI.UI.Business_Address_Activity")
        )
        startActivity(webIntent)
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    } catch (e: ClassNotFoundException) {
...
fun AppCompatActivity.startListToppers(session: UserSessionManager?) {
    try {
        ...
        val webIntent =
            Intent(this, Class.forName("com.nowfloats.education.toppers.ToppersActivity"))
        startActivity(webIntent)
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    } catch (e: ClassNotFoundException) {
        e.printStackTrace()
...
fun AppCompatActivity.startListBatches(session: UserSessionManager?) {
    try {
        ...
        val webIntent =
            Intent(this, Class.forName("com.nowfloats.education.batches.BatchesActivity"))
        startActivity(webIntent)
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    } catch (e: ClassNotFoundException) {
        e.printStackTrace()
...
fun AppCompatActivity.startFacultyMember(session: UserSessionManager?) {
    try {
        ...
        val webIntent =
            Intent(this, Class.forName("com.nowfloats.education.faculty.FacultyActivity"))
        startActivity(webIntent)
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
    } catch (e: ClassNotFoundException) {
        e.printStackTrace()
