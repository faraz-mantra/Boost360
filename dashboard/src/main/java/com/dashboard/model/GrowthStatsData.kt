...
class GrowthStatsData(
  ...
  fun getData(summary: SummaryEntity?, mapVisitCount: String?,searchCount: String?): ArrayList<GrowthStatsData> {
    ...
    list.add(GrowthStatsData(title = "Address\nviews", value = mapVisitCount, icon1 = R.drawable.ic_address_view_d,type = GrowthType.ADDRESS_NEWS.name))
    ...
    list.add(GrowthStatsData(title = "Search\nQueries", value = searchCount, icon1 = R.drawable.ic_search_queries_d,type = GrowthType.SEARCH_QUERIES.name))
    return list
  }
