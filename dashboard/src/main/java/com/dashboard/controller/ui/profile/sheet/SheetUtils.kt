...
fun Fragment.showEditUserNameSheet(userName: String, click: () -> Unit) {
  EditChangeUserNameSheet { click() }.apply {
    arguments = Bundle().apply { putString(EditChangeUserNameSheet.IK_NAME, userName) }
  }.show(parentFragmentManager, EditChangeUserNameSheet::javaClass.name)
}
