...
interface WebActionRemoteDataSource {
  ...
  fun getWhatsAppBusiness(@Header("Authorization") auth: String, @Query("query") request: String?, @Query("limit") limit: Int? = 1): Observable<Response<ChannelWhatsappResponse>>
}