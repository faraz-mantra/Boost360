...
interface WebActionRemoteDataSource {
  ...
  fun updateWhatsAppNumber(@Body request: UpdateChannelActionDataRequest): Observable<Response<String>>

  @GET(EndPoints.GET_WHATSAPP_BUSINESS)
  fun getWhatsAppBusiness(@Query("query") request: String?, @Query("limit") limit: Int? = 1): Observable<Response<ChannelWhatsappResponse>>
}