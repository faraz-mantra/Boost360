...
class ChannelContentBuilder(
  var context: BaseActivity<*, *>, items: ObservableList<ChannelModel>, autoDismiss: Boolean = true,
  val onItemClick: OnItemClick<ChannelModel>
