...
fun <T : AppBaseRecyclerViewItem> BaseRecyclerView.setGridRecyclerViewAdapter(activity: BaseActivity<*, *>, spanCount: Int, list: List<T>): AppBaseRecyclerViewAdapter<T> {
