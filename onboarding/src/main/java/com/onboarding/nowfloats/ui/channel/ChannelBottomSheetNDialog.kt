...
@Deprecated("not use")
class ChannelBottomSheetNDialog :
  BaseDialogFragment<DialogChannelBottomSheetNewBinding, BaseViewModel>(),
  ...
  override fun onCreateView() {
    ...
    val text = StringBuilder(
      resources.getString(R.string.recommended_on) + " " + list.size + " " + resources.getString(R.string.channel)
    )
