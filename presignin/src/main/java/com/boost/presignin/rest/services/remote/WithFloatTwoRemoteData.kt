...
interface WithFloatTwoRemoteData {
  ...
  fun sendOtpIndia(@Query("mobileNumber") number: Long?, @Query("messageTemplate") messageTemplate: String? = "Your one time Boost 360 verification code is [OTP]. The code is valid for 10 minutes, Please DO NOT share this code with anyone.#W5izmPg6WcR", @Query(value = "clientId") clientId: String?): Observable<Response<ResponseBody>>
