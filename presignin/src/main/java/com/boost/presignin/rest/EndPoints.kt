...
object EndPoints {
  ...
  const val VERTICAL_VERIFY_LOGIN = "/discover/v3/floatingPoint/verifyLogin"
  ...
  const val VERTICAL_VERIFY_LOGIN_OTP = "/discover/v2/floatingpoint/VerifyLoginOTP"
  ...
  const val GET_STORED_DATA ="discover/v1/Onboarding/get-stored-data"
  const val STORE_ONBOARDING_DATA ="discover/v1/Onboarding/storing-data"
