...
import com.framework.webengageconstant.START_INTRO_ANIMATION
...
class IntroSlideItemFragment : AppBaseFragment<ItemIntroNewSlidesBinding, BaseViewModel>() {
    ...
    override fun onCreateView() {
        ...
        if (BuildConfig.FLAVOR.equals("partone") || BuildConfig.FLAVOR.equals("jioonline")) {
            binding.lottieAnimationIntro.visibility = View.VISIBLE
            ...
            binding.lottieAnimationIntro.apply {
                ...
                repeatCount =
                    if (!introSlideItem.isLottieRepeat) introSlideItem.count else LottieDrawable.INFINITE
            ...
            binding.lottieAnimationIntro.addAnimatorListener(object : Animator.AnimatorListener {
                ...
                override fun onAnimationStart(animation: Animator) {
                    ...
                    if (position == 0) WebEngageController.trackEvent(
                        PS_INTRO_SCREEN_START,
            ...
            binding.introView.visibility = View.VISIBLE
            if (introSlideItem.sliderImage == R.drawable.intro_slide1) {
                binding.introView.scaleType = ImageView.ScaleType.CENTER_CROP
            }
            if (introSlideItem.sliderImage == R.drawable.intro_slide2) {
                binding.introView.scaleType = ImageView.ScaleType.FIT_CENTER
            }
            if (introSlideItem.sliderImage == R.drawable.intro_slide3) {
                binding.introView.scaleType = ImageView.ScaleType.FIT_CENTER
            }
            if (introSlideItem.sliderImage == R.drawable.intro_slide4) {
                binding.introView.scaleType = ImageView.ScaleType.CENTER_INSIDE
            }
            Glide.with(activity?.applicationContext!!).load(introSlideItem.sliderImage)
                .into(binding.introView)
        }
