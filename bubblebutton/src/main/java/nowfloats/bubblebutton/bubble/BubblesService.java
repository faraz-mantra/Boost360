...
public class BubblesService extends Service {
    ...
    public void addBubble(BubbleLayout bubble2, final int x, final int y) {
        ...
        bubbleView.setOnBubbleClickListener(new BubbleLayout.OnBubbleClickListener() {
            ...
            public void onBubbleClick(BubbleLayout bubble) {
                ...
                if(isDialogShowing){
                    ...
                    Intent it = new Intent(BubblesService.this, BubbleDialog.class).
    ...
    private void killDialog(){
        ...
        sendBroadcast(new Intent(BubbleDialog.KILL_DIALOG));
    }
