...
public class EmojiconGridView{
    ...
    OnEmojiconClickedListener mEmojiconClickedListener;
    Emojicon[] mData;
    private boolean mUseSystemDefault = false;


    public EmojiconGridView(Context context, Emojicon[] emojicons, EmojiconRecents recents, OnEmojiconClickedListener emojiconClickedListener, boolean useSystemDefault) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        rootView = inflater.inflate(R.layout.emojicon_grid, null);
        mEmojiconClickedListener = emojiconClickedListener;
        setRecents(recents);
