...
public class ShowWebView extends AppCompatActivity {
    ...
    LinearLayout layout;
    Toolbar toolbar;
    final static String Type="facebook";
    private static String url="http://nfx.withfloats.com/dataexchange/v2/fetch/analytics?" +
            "identifier="+Type+"&nowfloats_id=";
    ...
    private void checkForMessage(){
        ...
        facebookApis.nfxFetchFacebookData(session.getFPID(), Type, new Callback<GetFacebookAnalyticsData>() {
            @Override
