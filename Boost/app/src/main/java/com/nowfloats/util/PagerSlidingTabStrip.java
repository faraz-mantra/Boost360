...
/**
 * Created by Kamal on 17-03-2015.
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.button_pressed;
    ...
    public void notifyDataSetChanged() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            //    tabsContainer.getChildAt(currentPosition).st
    ...
    private void addIconTab(final int position, int resId) {
        ...
        System.out.println("Position is "+position+"RESIS "+resId);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height - 13, rectPaint);
