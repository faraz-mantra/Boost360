...
class TextInputManager private constructor() : CoroutineScope by MainScope(), InputKeyEventReceiver,
  ...
  override fun onRegisterInputView(inputView: InputView) {
    ...
    businessFeaturesManager = BusinessFeaturesManager(inputView, florisboard)
  ...
  private fun updateCapsState() {
    if (!capsLock) {
      caps = florisboard.prefs.correction.autoCapitalization && activeEditorInstance.cursorCapsMode != InputAttributes.CapsMode.NONE
