...
class VisitingCardSixViewHolder(binding: ItemVisitingCardSixBinding, val listener: OnItemClickListener?) : BaseRecyclerViewHolder<ItemVisitingCardSixBinding>(binding) {
