...
class VisitingCardEightViewHolder(binding: ItemVisitingCardEightBinding, val listener: OnItemClickListener?) : BaseRecyclerViewHolder<ItemVisitingCardEightBinding>(binding) {
