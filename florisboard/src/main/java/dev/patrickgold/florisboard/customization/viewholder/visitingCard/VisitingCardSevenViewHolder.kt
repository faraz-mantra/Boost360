...
class VisitingCardSevenViewHolder(binding: ItemVisitingCardSevenBinding, val listener: OnItemClickListener?) : BaseRecyclerViewHolder<ItemVisitingCardSevenBinding>(binding) {
