...
class VisitingCardTenViewHolder(binding: ItemVisitingCardTenBinding, val listener: OnItemClickListener?) : BaseRecyclerViewHolder<ItemVisitingCardTenBinding>(binding) {
