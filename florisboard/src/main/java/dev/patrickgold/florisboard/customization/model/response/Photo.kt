...
data class Photo(
  ...
  enum class ViewGridType(var width:Int,var countGrid:Int,var icon:Int){
    FIRST_GRID(280,1, R.drawable.ic_layout_one_f),SECOND_GRID(220,2,R.drawable.ic_layout_two_f),THIRD_GRID(174,3,R.drawable.ic_layout_three_f),FOUR_GRID(132,4,R.drawable.ic_layout_four_f),
  }
}