...
data class Photo(
  ...
  enum class ViewGridType(var width:Int,var countGrid:Int,var icon:Int){
    FIRST_GRID(286,1, R.drawable.ic_layout_one_f),SECOND_GRID(226,2,R.drawable.ic_layout_two_f),THIRD_GRID(180,3,R.drawable.ic_layout_three_f),FOUR_GRID(138,4,R.drawable.ic_layout_four_f),
  }
}