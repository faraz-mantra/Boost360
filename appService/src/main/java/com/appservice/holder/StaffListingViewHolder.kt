...
class StaffListingViewHolder(binding: RecyclerItemStaffListingBinding) : AppBaseRecyclerViewHolder<RecyclerItemStaffListingBinding>(binding) {
  ...
  override fun bind(position: Int, item: BaseRecyclerViewItem) {
    ...
    activity?.glideLoad(binding.civImage, data.getUrlImage(), R.drawable.placeholder_image_n)
    ...
    binding.btnViewProfile.setOnClickListener {
      listener?.onItemClick(position, data, RecyclerViewActionType.STAFF_LISTING_CLICK.ordinal)
    }
