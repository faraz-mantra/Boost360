...
interface WebActionBoostKitRemoteData {
  ...
  fun addKycData(@Header("Authorization") auth: String?, @Body request: PaymentKycRequest?): Observable<Response<ResponseBody>>

  @POST(EndPoints.UPDATE_DATA_KYC)
  fun updateKycData(@Header("Authorization") auth: String?, @Body request: UpdatePaymentKycRequest): Observable<Response<ResponseBody>>
