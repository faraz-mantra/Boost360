...
class TestimonialViewModel : BaseViewModel() {
  ...
  fun getTestimonialsList(testimonialType: String?, query: JSONObject?, skip: Int, limit: Int): LiveData<BaseResponse> {
    return BoostKitDevRepository.getTestimonialsList(testimonialType, query, skip, limit).toLiveData()
  }
...
//  }
  ...
  fun deleteTestimonials(testimonialType: String?, body: DeleteTestimonialRequest?): LiveData<BaseResponse> {
    return BoostKitDevRepository.deleteTestimonials(testimonialType, body).toLiveData()
  }
}
