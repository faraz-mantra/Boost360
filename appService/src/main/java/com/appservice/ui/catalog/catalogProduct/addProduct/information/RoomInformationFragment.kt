...
import com.appservice.databinding.FragmentRoomInformationBinding
...
class RoomInformationFragment : AppBaseFragment<FragmentRoomInformationBinding, ServiceViewModel>(), RecyclerItemClickListener {
    ...
    companion object {
        fun newInstance(): RoomInformationFragment {
    ...
    override fun onCreateView() {
        ...
        setOnClickListener(
            binding.btnAddTag, binding.btnAddSpecification, binding.btnConfirm,
            binding.btnClickPhoto, binding.tvAddExternalLinkBtn
            /**,
...
//  }
    ...
    private fun specificationAdapter() {
        binding.rvSpecification?.apply {
            adapterSpec =
                AppBaseRecyclerViewAdapter(baseActivity, specList, this@RoomInformationFragment)
            adapter = adapterSpec
        }
    }
    ...
    override fun onClick(v: View) {
        ...
        when (v) {
            ...
            binding.tvAddExternalLinkBtn -> setUpUIExternalLink()
    ...
    private fun setUpUIExternalLink() {
        binding.tvAddExternalLinkBtn.gone()
        binding.linearExternalUrl.visible()
    }
    ...
    private fun openImagePicker() {
        ...
        filterSheet.show(
            this@RoomInformationFragment.parentFragmentManager,
...
//    val spinnerOnlinePayment = binding.spinnerOnlinePayment?.selectedItem as SpinnerImageModel
        ...
        val keyWebsiteName = binding.edtKeyWebsiteName?.text?.toString() ?: ""
        val valueExternalUrl = binding.edtValueExternalUrl?.text?.toString() ?: ""
...
//        product?.category = serviceCategory
    ...
    private fun setAdapter() {
        if (adapterImage == null) {
            binding.rvAdditionalDocs?.apply {
                adapterImage = AppBaseRecyclerViewAdapter(baseActivity, secondaryImage, this@RoomInformationFragment)
    ...
    private fun openGStDetail() {
        ...
        gstSheet.show(this@RoomInformationFragment.parentFragmentManager, ImagePickerBottomSheet::class.java.name)
    }
