...
public class roboto_md_36_289dd9 extends TextView {

    public roboto_md_36_289dd9(Context context) {
        super(context);
        init(context);
    }
    ...
    public roboto_md_36_289dd9(Context context, AttributeSet attrs, int defStyle) {
