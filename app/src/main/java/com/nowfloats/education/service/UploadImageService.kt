...
class UploadImageService(private val listener: UploadImageServiceListener, private val uploadImages: List<UploadImageModel>) : AsyncTask<Void?, String?, String?>() {
        ...
        uploadImages.forEach {
            ...
            try {
                ...
                val requestBody: RequestBody = MultipartBody.Builder()
                        ...
                        .addFormDataPart("file", it.fileName, RequestBody.create("image/*".toMediaTypeOrNull(), buf))
                        .build()
                ...
                when {
                    response != null && response.code == 200 -> {
                        val responseImageModel = ResponseImageModel(it.fileName, Objects.requireNonNull(response.body)!!.string())
