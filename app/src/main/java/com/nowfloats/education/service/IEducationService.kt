...
interface IEducationService {
  ...
  fun getUpcomingBatches(
    ...
    @Query("skip") skip: Int
  ): Observable<UpcomingBatchesResponse>
  ...
  fun getOurToppers(
    ...
    @Query("limit") limit: Int,
    @Query("skip") skip: Int
  ): Observable<OurTopperResponse>

  @POST("upcoming_batches/add-data")
  fun addUpcomingBatches(
    @Header("Authorization") auth: String?,
    @Body addUpcomingBatchModel: AddUpcomingBatchModel
  ): Observable<String>

  @POST("upcoming_batches/update-data")
  fun updateUpcomingBatch(
    @Header("Authorization") auth: String?,
    @Body updateUpcomingBatchModel: UpdateUpcomingBatchModel
  ): Observable<String>

  @POST("upcoming_batches/update-data")
  fun deleteUpcomingBatch(
    @Header("Authorization") auth: String?,
  ...
  fun addOurTopper(
    @Header("Authorization") auth: String?,
    @Body addTopperModel: AddTopperModel
  ): Observable<String>

  @POST("our_toppers/update-data")
  fun updateOurTopper(
    @Header("Authorization") auth: String?,
    @Body updateTopperModel: UpdateTopperModel
  ): Observable<String>
  ...
  fun addOurFaculty(
    @Header("Authorization") auth: String?,
    @Body addFacultyModel: AddFacultyModel
  ): Observable<String>

  @POST("our_faculty/update-data")
  fun updateOurFaculty(
    @Header("Authorization") auth: String?,
    @Body updateFacultyModel: UpdateFacultyModel
  ): Observable<String>

  @POST("our_faculty/update-data")
  fun deleteOurFaculty(
    @Header("Authorization") auth: String?,
    @Body deleteModel: DeleteModel
  ): Observable<String>
