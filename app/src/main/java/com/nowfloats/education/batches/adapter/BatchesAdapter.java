...
public class BatchesAdapter extends RecyclerView.Adapter<BatchesAdapter.ViewHolder> {
    ...
    public BatchesAdapter(List<String> itemList, TestimonialsListener listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_single_batches, null);
