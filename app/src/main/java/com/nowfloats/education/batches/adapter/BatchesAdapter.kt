...
class BatchesAdapter(private val eventListener: ItemClickEventListener) : RecyclerView.Adapter<BatchesAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: BatchesItemBinding) : RecyclerView.ViewHolder(binding.root) {
