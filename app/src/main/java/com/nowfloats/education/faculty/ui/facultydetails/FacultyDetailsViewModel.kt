...
class FacultyDetailsViewModel(private val service: IEducationService,
    ...
    fun getFacultyProfileImageUrl(filePath: String) {
        ...
        val url = EDUCATION_API_BASE_URL + UPLOAD_OUR_FACULTY_IMAGE_URL + FACULTY_PROFILE_IMAGE + JPEG_FORMAT
