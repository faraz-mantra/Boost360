...
public class TopperAdapter extends RecyclerView.Adapter<TopperAdapter.ViewHolder> {
    ...
    public TopperAdapter(List<String> itemList, TestimonialsListener listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_single_topper, null);
