...
class TopperDetailsViewModel(private val service: IEducationService,
                             private val fileProvider: FileProvider,
                             private val saveImageHelper: SaveImageHelper,
                             private val exifInterfaceHelper: ExifInterfaceHelper) : ViewModel(), UploadImageServiceListener {
    ...
    fun updateOurTopper(topperData: Data, profileImageUrl: String?, testimonialImageUrl: String?) {
        ...
        val set = Set(coursecategory = topperData.coursecategory,
                name = topperData.name,
                profileimage = profileImage,
                programavailed = topperData.programavailed,
    ...
    fun getToppersImagesUrl(profileImagePath: String?, testimonialImagePath: String?) {
        ...
        val profileImageApiUrl = EDUCATION_API_BASE_URL + UPLOAD_OUR_TOPPER_IMAGE_URL + TOPPER_PROFILE_IMAGE + JPEG_FORMAT
        val testimonialImageApiUrl = EDUCATION_API_BASE_URL + UPLOAD_OUR_TOPPER_IMAGE_URL + TOPPER_TESTIMONIAL_IMAGE + JPEG_FORMAT
        ...
        testimonialImagePath?.let {
            val testimonialImageModel = UploadImageModel(testimonialImageApiUrl, it, TOPPER_TESTIMONIAL_IMAGE)
