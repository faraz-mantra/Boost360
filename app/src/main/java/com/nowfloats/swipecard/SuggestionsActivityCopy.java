...
//
//
//public class SuggestionsActivityCopy extends AppCompatActivity implements SwipeStack.SwipeStackListener {
//
...
//        session = new UserSessionManager(getApplicationContext(), SuggestionsActivityCopy.this);
...
//        flTopView = (LinearLayout) findViewById(R.id.flTopView);
...
//        fragmentTransaction.replace(R.id.flTopView, new OnBoardingFragment())
//                .addToBackStack(null)
//                .commit();
//
//
...
//                switch (share_via) {
//                    case GMAIL:
//                        Picasso.with(SuggestionsActivityCopy.this)
//                                .load(sugUpdates.getImage())
//                                .into(new Target() {
//                                    @Override
//                                    public void onBitmapLoaded(final Bitmap bitmap, Picasso.LoadedFrom from) {
//                                        Bitmap mutableBitmap = bitmap.copy(Bitmap.Config.ARGB_8888, true);
//                                        View view = new View(SuggestionsActivityCopy.this);
...
//                                            } else {
//                                                Methods.showSnackBarNegative(SuggestionsActivityCopy.this, getString(R.string.no_app_available_for_action));
//                                            }
//
//                                        } catch (Exception e) {
//                                            ActivityCompat.requestPermissions(SuggestionsActivityCopy.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE, android.Manifest.permission.CAMERA}, 2);
//                                        }
//                                    }
//
//                                    @Override
//                                    public void onBitmapFailed(Drawable errorDrawable) {
//                                        Methods.showSnackBarNegative(SuggestionsActivityCopy.this, getString(R.string.failed_to_download_image));
//
//                                    }
//
//                                    @Override
...
//            mSwipeStackAdapter.refresh(suggestions.getSuggestionList());
...
//                addCoachMarks();
//        } else {
//            Methods.showSnackBarNegative(SuggestionsActivityCopy.this, getString(R.string.no_info_avail));
//            finish();
//        }
//    }
//
...
//        View view = LayoutInflater.from(SuggestionsActivityCopy.this)
//                .inflate(R.layout.coach_mark_swipe_view, llCoachMark);
//
//        AnimationSet animationSet = new AnimationSet(true);
//
//        Animation rightAnimation = AnimationUtils.loadAnimation(SuggestionsActivityCopy.this, R.anim.slide_coach_mark_right);
//        Animation leftAnimation = AnimationUtils.loadAnimation(SuggestionsActivityCopy.this, R.anim.slide_coach_mark_left);
...
//
//    private void prepareCoachMark(final SuggestionsActivity.TARGETVIEW targetview) {
//
//
//        switch (targetview) {
//            case VIEW_MORE:
...
//    }
//
//    private void showCoachMark(final SuggestionsActivity.TARGETVIEW targetview) {
//
