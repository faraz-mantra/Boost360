 ...
 */
public class ProductImageReplace extends AsyncTask<String,String,String>{
    public String url="";
    ...
    public ProductImageReplace(String url, byte[] imageData, Product_Detail_Activity activity){
