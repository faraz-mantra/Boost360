...
public class HelpAndSupportFragment extends Fragment
{
    ...
    private boolean isChatEnabled = true, isPhoneEnabled = true;
...
//        tvTextRia.setMovementMethod(LinkMovementMethod.getInstance());
    ...
    private void getRiaMembers(HashMap<String, String> map, final View view)
    {
        ...
        riaNetworkInterface.getAllMemberForFp(map, new Callback<List<RiaSupportModel>>() {
            ...
            public void success(List<RiaSupportModel> list, Response response) {
                ...
                if (list == null || list.size() == 0 || response.getStatus() < 200 || response.getStatus() > 300)
                {
                    addDefaultRiaData();
                }
    ...
    private class viewPagerAdapter extends FragmentStatePagerAdapter
    {
        ...
        public Fragment getItem(int position)
        {
            ...
            b.putBoolean(HelpAndSupportCardItemFragment.CHAT_SUPPORT_ENABLED, isChatEnabled);
            b.putBoolean(HelpAndSupportCardItemFragment.PHONE_SUPPORT_ENABLED, isPhoneEnabled);
     ...
     */
    private boolean isNewPricingPlan()
    {
        ...
        else
        {
            ...
            if(phone.equals(WidgetKey.WidgetValue.FEATURE_NOT_AVAILABLE.getValue()))
            {
