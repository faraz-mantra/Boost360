...
public class TeamsDetailsFragment extends Fragment {
    ...
    private TeamsDetailsViewModel mViewModel;

    public static TeamsDetailsFragment newInstance() {
        return new TeamsDetailsFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        mViewModel = ViewModelProviders.of(this).get(TeamsDetailsViewModel.class);
