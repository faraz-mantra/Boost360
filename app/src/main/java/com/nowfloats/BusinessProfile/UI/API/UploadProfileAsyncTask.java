...
public class UploadProfileAsyncTask extends AsyncTask<Void, String, String> {
    ...
    public UploadProfileAsyncTask(Activity context, JSONObject obj, String[] profilesattr, ListenerRepose listenerRepose) {
...
//			pd.show();
    ...
    protected void onPostExecute(String result) {
        ...
        if (result == null) {
            ...
            if (this.listenerRepose != null) this.listenerRepose.success(false);
            return;
        }
    ...
    protected String doInBackground(Void... arg0) {
        ...
        if (obj != null) content = obj.toString();
        response = getDataFromServer(content, Constants.HTTP_POST, Constants.FpsUpdate, Constants.BG_SERVICE_CONTENT_TYPE_JSON);
