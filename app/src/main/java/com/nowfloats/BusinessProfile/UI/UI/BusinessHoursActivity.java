...
public class BusinessHoursActivity extends AppCompatActivity implements View.OnTouchListener, TimePickerDialog.OnTimeSetListener, View.OnClickListener, AdapterView.OnItemSelectedListener {
  ...
  private boolean isValidInput() {
    if (switchSun.isChecked()) {
      if (etSunOpen.getText().toString().equals("00:00") || etSunClose.getText().toString().equals("00:00")) return false;
    }
    if (switchMon.isChecked()) {
      if (etMonOpen.getText().toString().equals("00:00") || etMonClose.getText().toString().equals("00:00")) return false;
    }
    if (switchTue.isChecked()) {
      if (etTueOpen.getText().toString().equals("00:00") || etTueClose.getText().toString().equals("00:00")) return false;
    }
    if (switchWed.isChecked()) {
      if (etWedOpen.getText().toString().equals("00:00") || etWedClose.getText().toString().equals("00:00")) return false;
    }
    if (switchThu.isChecked()) {
      if (etThuOpen.getText().toString().equals("00:00") || etThuClose.getText().toString().equals("00:00")) return false;
    }
    if (switchFri.isChecked()) {
      if (etFriOpen.getText().toString().equals("00:00") || etFriClose.getText().toString().equals("00:00")) return false;
    }
    if (switchSat.isChecked()) {
      if (etSatOpen.getText().toString().equals("00:00") || etSatClose.getText().toString().equals("00:00")) return false;
    }
    return true;
  }
