...
public interface EventKeysWL {
    ...
    String PROFILE_SCREEN = "SignUpEnterDetails";
    String NUMBER_ALREADY_REGISTERED = "NumberAlreadyRegistered";
    ...
    String CREATE_MESSAGE_ACTIVITY_IMAGE_NOT_SELECTED = "TextUpdate";
    String CREATE_MESSAGE_ACTIVITY_IMAGE_SELECTED = "ImageUpdate";
    String CREATE_MESSAGE_ACTIVITY_FACEBOOK_SELECTED = "PostToFB";
    String CREATE_MESSAGE_ACTIVITY_FACEBOOK_PAGE = "PostToFBPage";
    String CREATE_MESSAGE_ACTIVITY_TWITTER = "PostToTwitter";
    String CREATE_MESSAGE_ACTIVITY_SEND_TO_SUBSCRIBERS = "PostToSubscribers";
    // String CREATE_MESSAGE_ACTIVITY_POST = "PostAnUpdateButtonPressed";
    String MESSAGE_FULL_VIEW = "MessageDetailView";
    ...
    String IMAGE_GALLERY_IMAGE_GALLERY = "ImageGalleryFromGallery";
    ...
    String UPDATE_LOGO_GALLERY = "UpdateLogoFromGallery";

    String SHOW_MOBILE_WEB_SITE = "ShowMobileWebsite";
    String SHOW_MOBILE_WEB_SITE_CANCEL = "CancelShowMobileWebsite";

    String SITE_SCORE_GET_YOUR_OWN_IDENTITY = "SiteScoreBuyDotCom";
    String SITE_SCORE_PHONE_NUMBER = "SiteScoreUpdatePhoneNumber";
    String SITE_SCORE_Businesss_CATEGORY = "SiteScoreUpdateBusinessCategory";
    String SITE_SCORE_FEATURED_IMAGE = "SiteScoreUpdateFeaturedImage";
    String SITE_SCORE_BUSINESS_NAME = "SiteScoreUpdateBusinessName";
    String SITE_SCORE_BUSINESS_DESC = "SiteScoreBusinessDesc";
    String SITE_SCORE_GET_SOCIAL = "SiteScoreUpdateSocialSharing";
    String SITE_SCORE_HELP_YOUR_CUSTOMERS = "SiteScoreUpdateAddress";
    String SITE_SCORE_ADD_EMAIL = "SiteScoreUpdateEmail";
    String SITE_SCORE_POST_5_UPDATES = "SiteScorePostAnUpdate";
    ...
    String STORE_USER_INTERNATIONAL = "StoreUserInternational";
    String STORE_WIDGET_WILDFIRE = "WildfireWidget";
    String STORE_WIDGET_LIGHTHOUSE = "LighthouseWidget";
    String STORE_WIDGET_PROPACK = "PropackWidget";
