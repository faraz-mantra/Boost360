package com.nowfloats.customerassistant.coachmarks;
...
public abstract class InternallyAnchoredCoachMark extends CoachMark {
    ...
    protected CoachMarkDimens<Integer> getAnchorDimens() {
        ...
        final int x = 0;//(int) (anchorLoc[0] + mInternalAnchor.x * mAnchor.getMeasuredWidth());
        final int y = 0;//(int) (anchorLoc[1] + mInternalAnchor.y * mAnchor.getMeasuredHeight());
    ...
    public abstract static class InternallyAnchoredCoachMarkBuilder extends CoachMarkBuilder {
         ...
         *
         * @param x      the x coordinate of the top left corner of the internal anchor
         * @param y      the y coordinate of the top left corner of the internal anchor
         * @param width  the width of the internal anchor
         * @param height the height of the internal anchor
         */
