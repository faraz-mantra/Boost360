 ...
 */
public class UploadProfileImage extends AsyncTask<Void, String, String> {

    Activity appContext;
    String path, fileName;
    ProgressDialog pd = null;
    TestimonialsFeedbackListener listener;
    boolean isUploadingSuccess = false;

    public UploadProfileImage(Activity context, TestimonialsFeedbackListener listener, String path, String fileName) {
