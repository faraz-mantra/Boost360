...
public class API_Service {
    ...
    public void oldPricingPlans(final Activity activity, String id, String country, String acc_id
            ...
            try {
                ...
                storeInterface.getOldStoreList(params,new Callback<StoreMainModel>() {
                    @Override
    ...
    public void newPricingPlans(final Activity activity, String id, String country, String acc_id
