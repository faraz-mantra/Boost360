...
public class DataAccessibilityServiceV6 extends AccessibilityService {
...
//                    startActivity(intent);
                    ...
                    Intent intent = new Intent(DataAccessibilityServiceV6.this, BubblesService.class);
                    startService(intent);
                }
            } else {
                ...
                !event.getClassName().toString().contains(PK_NAME_NOWFLOATS)){
                    ...
                    Log.v("ggg1","closed");
                    stopService(new Intent(DataAccessibilityServiceV6.this, BubblesService.class));
                }
