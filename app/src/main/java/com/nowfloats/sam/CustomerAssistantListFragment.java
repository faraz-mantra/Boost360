...
public class CustomerAssistantListFragment extends android.app.Fragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View mainView = inflater.inflate(R.layout.fragment_sam_customer_list, container, false);
        return mainView;
    }
    ...
    private void updateList() {
        ...
        rvSAMCustomerList.setAdapter(samCustomersAdapter = new SAMCustomersAdapter(getActivity(),
