...
public class Key implements Comparable<Key> {
    ...
    public String getHeaderKeySpec() {
        return mHeaderKeySpec;
    }
    ...
    public final boolean isHeaderKey() {
    ...
    public final boolean isNumKey() {
        return mBackgroundType == BACKGROUND_TYPE_NUMKEY;
    }
