...
public final class KeyVisualAttributes {
    ...
    public final int mHeaderKeyTextColor;
    ...
    private KeyVisualAttributes(final TypedArray keyAttr, Typeface typeface) {
        if (typeface == null) {
        ...
        mHeaderKeyTextColor = keyAttr.getColor(R.styleable.Keyboard_Key_headerKeyTextColor, 0);
    ...
    public static KeyVisualAttributes newInstance(final TypedArray keyAttr, Typeface typeface) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            return new KeyVisualAttributes(keyAttr, typeface);
        }
        return null;
    }
}
