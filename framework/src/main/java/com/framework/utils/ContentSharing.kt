...
"""
    ...
    private fun shareTextService(activity: Activity, uri: Uri?, shareText: String, isWhatsApp: Boolean?, isFb: Boolean?, isLinkedin: Boolean?, isTwitter: Boolean?, intentChooserTitle: String? = BaseApplication.instance.getString(R.string.app_name)) {
    ...
    fun share(activity: Activity, shareText: String, imageUri: String? = null, isWhatsApp: Boolean? = false, isFb: Boolean? = false, isTwitter: Boolean? = false, isLinkedin: Boolean? = false) {
        ...
        val target: Target = object : Target {
          override fun onBitmapLoaded(bitmap: Bitmap, from: Picasso.LoadedFrom) {
            ...
            try {
              ...
              val path = MediaStore.Images.Media.insertImage(BaseApplication.instance.contentResolver, mutableBitmap, "boost_360", "")
