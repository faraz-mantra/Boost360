package com.framework.views.imageshaddow
...
class ShadowLayout(context: Context?, attrs: AttributeSet?, defStyleAttr: Int) : RelativeLayout(context, attrs, defStyleAttr) {
