    ...
    protected void onDrawKeyTopVisuals(final Key key, final Canvas canvas, final Paint paint,
        ...
        if (label != null) {
           ...
           /* Drawable dr = (Drawable) getContext().getResources().getDrawable(R.drawable.round_light_grey);
            ...
            dr.draw(canvas);*/
            if ((key.isHeaderKey() || key.getHeaderKeySpec() != null) && PointerTracker.KEYBOARD_TYPED_KEY != null && PointerTracker.KEYBOARD_TYPED_KEY.getLabel() != null && PointerTracker.isNormalKeyLabel(PointerTracker.KEYBOARD_TYPED_KEY.getLabel())) {
