...
public final class MoreKeysKeyboard extends Keyboard {
    ...
    public static class Builder extends KeyboardBuilder<MoreKeysKeyboardParams> {
        ...
        public Builder(final Context context, final Key key, final Keyboard keyboard,
            ...
            if (key.isHeaderKey() && key.isLabelModified()) {
                moreKeys = mParentKey.mHeaderMoreKeys;
            } else {
                moreKeys = mParentKey.getMoreKeys();
            }
        ...
        public MoreKeysKeyboard build() {
            ...
            final MoreKeySpec[] moreKeys;
            if (mParentKey.isHeaderKey() && mParentKey.isLabelModified()) {
                moreKeys = mParentKey.mHeaderMoreKeys;
            } else {
                moreKeys = mParentKey.getMoreKeys();
            }
