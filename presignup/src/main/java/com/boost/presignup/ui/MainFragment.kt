            ...
            if (Math.abs(deltaX) > MIN_DISTANCE) {
              ...
              if (root.videoPlayer.isPlaying) {
                ...
                videoCurrentPosition =
                  root.videoPlayer.getCurrentPosition(); //stopPosition is an int
  ...
  fun checkVideoPlaying() {
    checkvideo = object : CountDownTimer(6000, 1000) {
      ...
      override fun onFinish() {
        WebEngageController.trackEvent(
          PS_INTRO_VIDEO_FAILED_TO_START,
          SIX_THOUSANDS,
          NO_EVENT_VALUE
        )
...
//                    root.videoPlayer.setVideoURI(Uri.parse(videoURLs.get(0)))
          ...
          root.videoPlayer.start()
          WebEngageController.trackEvent(
            PS_INTRO_VIDEO_STARTED_ENGLISH,
            VIDEO_STARTED,
            NO_EVENT_VALUE
          )
        }
...
//                    root.videoPlayer.setVideoURI(Uri.parse(videoURLs.get(2)))
          ...
          root.videoPlayer.start()
          WebEngageController.trackEvent(
            PS_INTRO_VIDEO_STARTED_KANNADA,
            VIDEO_STARTED,
            NO_EVENT_VALUE
          )
        }
...
//                    root.videoPlayer.setVideoURI(Uri.parse(videoURLs.get(4)))
          ...
          root.videoPlayer.start()
          WebEngageController.trackEvent(
            PS_INTRO_VIDEO_STARTED_MALAYALAM,
            VIDEO_STARTED,
            NO_EVENT_VALUE
          )
        }
...
//                    root.videoPlayer.setVideoURI(Uri.parse(videoURLs.get(6)))
          ...
          root.videoPlayer.start()
          WebEngageController.trackEvent(
            PS_INTRO_VIDEO_STARTED_MARATHI,
            VIDEO_STARTED,
            NO_EVENT_VALUE
          )
        }
