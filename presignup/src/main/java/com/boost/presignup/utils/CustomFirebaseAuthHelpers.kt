...
//        .requestIdToken(activity.getString(R.string.default_web_client_id))
  ...
  fun AuthorizedFacebookUser(currentUser: FirebaseUser?) {
    if (currentUser != null) {
      ...
      var personName = if (currentUser.displayName.isNullOrEmpty() && userInfo != null) userInfo.displayName else currentUser.displayName
      var personEmail = (if (currentUser.email.isNullOrEmpty() && userInfo != null) userInfo.email else currentUser.email) ?: ""
      var uid = personEmail
