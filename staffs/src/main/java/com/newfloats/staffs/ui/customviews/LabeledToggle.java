...
public class LabeledToggle extends ToggleableView {
     ...
     */
    public LabeledToggle(Context context) {
        super(context);
        initView();
    }
     ...
     */
    public LabeledToggle(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
     ...
     */
    public LabeledToggle(Context context, AttributeSet attrs, int defStyleAttr) {
