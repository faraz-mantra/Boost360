...
class ServiceDetailFragment : AppBaseFragment<FragmentServiceDetailBinding, ServiceViewModel>() {
    ...
    override fun onClick(v: View) {
        ...
        when (v) {
            ...
            binding?.vwChangeDeliverLocation -> {
                showServiceDeliveryLocationBottomSheet()
            }
    ...
    private fun showServiceDeliveryConfigBottomSheet() {
        ...
        dialog.show(parentFragmentManager, ServiceDeliveryConfigBottomSheet::class.java.getName())
    }

    private fun showServiceDeliveryLocationBottomSheet() {
        val dialog = ServiceDeliveryBottomSheet()
        dialog.show(parentFragmentManager, ServiceDeliveryBottomSheet::class.java.getName())
    }

    private fun showPaymentConfigBottomSheet() {
        val dialog = PaymentConfigBottomSheet()
        dialog.show(parentFragmentManager, PaymentConfigBottomSheet::class.java.getName())
    }
