...
class SendFeedbackAptSheetDialog : BaseBottomSheetDialog<BottomSheetSendFeedbackAptBinding, BaseViewModel>() {

  private var orderItem: OrderItem? = null
  var onClicked: (feedbackMessage: String) -> Unit = { }
  ...
  override fun onClick(v: View) {
    ...
    dismiss()
    when (v) {
      binding?.buttonDone -> onClicked((binding?.txtReason?.text?.toString() ?: ""))
    }
  }
