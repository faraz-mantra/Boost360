...
class ChoosePurposeBottomSheetDialog : BaseBottomSheetDialog<BottomSheetChoosePurposeBinding, BaseViewModel>(), RecyclerItemClickListener{
    ...
    override fun onCreateView() {
        binding?.recyclerViewBottomSheetChoosePurpose?.post {
            ...
            binding?.recyclerViewBottomSheetChoosePurpose?.layoutManager = LinearLayoutManager(baseActivity)
