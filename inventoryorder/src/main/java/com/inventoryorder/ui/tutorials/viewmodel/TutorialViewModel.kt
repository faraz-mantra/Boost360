...
class TutorialViewModel : BaseViewModel() {
  ...
  fun getLearnStaffResponse(): MutableLiveData<LearnAboutAppointmentMgmt> {
    val jsonResourceReader = JSONResourceReader(
      BaseOrderApplication.instance.applicationContext.resources,
      R.raw.learn_about_staff
    )
