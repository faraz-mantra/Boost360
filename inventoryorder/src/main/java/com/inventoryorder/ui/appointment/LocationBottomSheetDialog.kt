...
class LocationBottomSheetDialog :
  BaseBottomSheetDialog<BottomSheetServiceLocationBinding, BaseViewModel>(),
  ...
  override fun onCreateView() {
    binding?.recyclerViewBottomSheetServiceLocation?.post {
      ...
      binding?.recyclerViewBottomSheetServiceLocation?.layoutManager =
  ...
  override fun onItemClick(
    ...
    list.forEach {
      it.isSelected = (it.serviceOptionSelectedName == deliveryItem?.serviceOptionSelectedName)
    }
