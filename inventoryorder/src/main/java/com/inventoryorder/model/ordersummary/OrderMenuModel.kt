...
class OrderMenuModel(
  ...
  enum class MenuStatus(var title: String, var color: Int) {
    CONFIRM_ORDER("Confirm Order", R.color.black_4a4a4a), CONFIRM_APPOINTMENT("Confirm", R.color.black_4a4a4a),
    REQUEST_PAYMENT("Request Payment", R.color.black_4a4a4a),
    CANCEL_ORDER("Cancel Order", R.color.watermelon_light_10), CANCEL_APPOINTMENT("Cancel", R.color.watermelon_light_10),
    MARK_PAYMENT_DONE("Mark Payment Done", R.color.black_4a4a4a),
    MARK_AS_DELIVERED("Mark as delivered", R.color.black_4a4a4a), CUSTOMER_SERVED("Customer Served", R.color.black_4a4a4a),
