...
enum class OrderStatusValue(val type: String, val status: String, val value: String, val icon: Int = 0) {
    ...
    DELIVERY_COMPLETED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.DELIVERY_COMPLETED.name, "Delivered",R.drawable.ic_order_ready),
    ...
    FEEDBACK_RECEIVED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.FEEDBACK_RECEIVED.name, "Delivered",R.drawable.ic_order_ready),
    ...
    ORDER_COMPLETED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.ORDER_COMPLETED.name, "Delivered",R.drawable.ic_order_ready),
