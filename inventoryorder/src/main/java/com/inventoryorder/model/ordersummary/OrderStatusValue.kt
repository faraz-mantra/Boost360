...
enum class OrderStatusValue(val type: String, val status: String, val value: String, val icon: Int = 0) {
    ...
    DELIVERY_COMPLETED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.DELIVERY_COMPLETED.name, "Completed",R.drawable.ic_order_ready),
    FEEDBACK_PENDING_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.FEEDBACK_PENDING.name, "Completed",R.drawable.ic_order_ready),
    ...
    DELIVERY_DELAYED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.DELIVERY_DELAYED.name, "Delayed",R.drawable.ic_order_canceled),
    DELIVERY_FAILED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.DELIVERY_FAILED.name, "Failed",R.drawable.ic_order_canceled),
    ORDER_COMPLETED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.ORDER_COMPLETED.name, "Completed",R.drawable.ic_order_ready),
    ...
    ESCALATED_1(OrderSummaryModel.OrderType.ORDER.name, OrderSummaryModel.OrderStatus.ESCALATED.name, "Escalated",R.drawable.ic_order_canceled),
